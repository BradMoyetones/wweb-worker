...
import { ThemeToggle } from "./theme-toggle-2";
import { TooltipWrapper } from "./tooltip-wrapper";
import { getPresetThemeStyles } from "@/utils/theme/utils/theme-preset-helper";
...
export const ThemePresetCycleControls: React.FC<ThemePresetCycleControlsProps> = ({
  filteredPresets,
  currentPresetName,
  className,
  ...props
